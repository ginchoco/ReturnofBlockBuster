...
public class LinkedBinaryTree<T> implements BinaryTree<T>
{
  ...
  public static void main(String[] args) {
      LinkedBinaryTree<String> left = new LinkedBinaryTree<String>("two", new LinkedBinaryTree<String>("four"), 
      new LinkedBinaryTree<String>("six"));
      LinkedBinaryTree<String> right = new LinkedBinaryTree<String>("three", new LinkedBinaryTree<String>("five"), 
      new LinkedBinaryTree<String>("seven"));
      LinkedBinaryTree<String> tree = new LinkedBinaryTree<String>("one", left, right);
